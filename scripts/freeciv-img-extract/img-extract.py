...
spec_files = {
  "amplio2" : [
    ...
    "veterancy.spec",
    "water.spec",
    # Epoch sprites (copied into data/amplio2/ from tileset/epoch/web/ by
    # install.sh before this extractor runs; regenerated by tools/art/make_sheet.ts)
    "epoch_units.spec",
    "epoch_buildings.spec"
  ],
  "trident" : [
    "auto_ll.spec",
    "fog.spec",
